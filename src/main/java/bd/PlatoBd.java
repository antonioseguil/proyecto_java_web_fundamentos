...
public class PlatoBd {
	...
	public PlatoBd() {
		if (PlatoBd.platoList.isEmpty()) {
			PlatoBd.platoList.add(new Plato(1, "Vino - Louis Vallon", "ORIGEN DE LOUIS VALLON – BORDEAUX ROUGE\n" + "\n"
					...
					"https://www.vinofr.com.pe/pagina-del-producto/louis-vallon-bordeaux-tinto", 50.00));
